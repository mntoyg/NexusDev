...
│   ├── TODO.md               #   Ready-to-execute micro-tasks (Cursor → Aider)
│   ├── QUEUE.md              #   Parked tasks awaiting Claude quota reset
...
├── .github/
│   ├── workflows/            # Antigravity: CI/CD + agent triggers
│   ├── ISSUE_TEMPLATE/       # OpenCode-generated
│   └── PULL_REQUEST_TEMPLATE.md
├── metrics/                  # Comet output (JSONL, gitignored except schema)
...
2. Pick an unclaimed task from [`context/TODO.md`](context/TODO.md) or an issue labelled `good-first-task`.
...
Full guidelines live in [`CONTRIBUTING.md`](CONTRIBUTING.md) *(maintained by Node 5 — OpenCode)*.
